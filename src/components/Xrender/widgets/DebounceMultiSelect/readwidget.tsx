...
import { DebounceMultiSelectProps } from './type'
import request from '@/request'

interface DebounceMultiSelectReadWidgetProps extends DebounceMultiSelectProps {}

function ReadWidget(props: DebounceMultiSelectReadWidgetProps) {
