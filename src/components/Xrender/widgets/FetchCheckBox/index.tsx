...
import { Checkbox, message } from 'famc'
import { config } from './config'
import ReadWidget from './readwidget'
import request from '@/request'
import { RadioLabelValue, FetchCheckBoxProps } from './type'

function FetchCheckBox(props: FetchCheckBoxProps) {
  ...
  const getLocalDataSource = useCallback(() => {
    ...
    enumNames.forEach((item: string, index) => {
...
FetchCheckBox.config = config
FetchCheckBox.ReadWidget = ReadWidget
